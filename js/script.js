...
calculateBtn.addEventListener("click", () => {
    ...
    if (bmi < 18.5) {
        ...
        descriptionResult = "memiliki berat badan yang sangat berlebih (obesitas). Anda perlu menurunkan berat badan agar sehat. Konsultasi dengan dokter Anda atau ahli diet tentang cara mencapai berat badan yang sehat.";
    }
    else {
